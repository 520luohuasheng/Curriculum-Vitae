...
var st = function() {
	var deg = 0;
	var stT = function(deg) {
		var r = deg * Math.PI / 180;
		canvasst.clearRect(0, 0, canwidth, canwidth);
		canvasst.beginPath();
		canvasst.strokeStyle = "#ff0000";
		canvasst.lineWidth = 10;
		canvasst.arc(canwidth / 2, canwidth / 2, radius, 0 - 1 / 2 * Math.PI, r - 1 / 2 * Math.PI, false); //
		canvasst.stroke();
	};
	var time = setInterval(function() {
		var con = document.getElementsByTagName("section")[2];
